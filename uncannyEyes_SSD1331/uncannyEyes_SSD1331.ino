...
//--------------------------------------------------------------------------
// For reference these are the pins on the teensy and how they are used
// Both eyes use the exact same pins except for the (chip select) cs pin
//   sclk 13
//   mosi 11
//   cs   10  //right eye
//   cs1  7   //left eye
...
void drawEye( // Renders one eye.  Inputs must be pre-clipped & valid.
  ...
  #endif
  #if defined THE1331
    eye[e].display->setAddrWindow(0, 0, SCLERA_WIDTH, SCLERA_HEIGHT);
#else // OLED
...
void frame( // Process motion for a single frame of left or right eye
  ...
  #if defined THE1331
    eyeX = map(eyeX, 0, 1023, 0, SCLERA_WIDTH  - 96);
  eyeY = map(eyeY, 0, 1023, 0, SCLERA_HEIGHT - 96);
  if(eyeIndex == 1) eyeX = (SCLERA_WIDTH - 96) - eyeX; // Mirrored display
  #else
  ...
  #if defined THE1331
  if(eyeX > (SCLERA_WIDTH - 96)) eyeX = (SCLERA_WIDTH - 96);
  #else
