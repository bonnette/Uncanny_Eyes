...
#include "graphics/defaultEye1.h"      // Standard human-ish hazel eye -OR-
...
#else
  {  7, -1, 0 }, // LEFT EYE display-select and wink pins, no rotation
...
// DISPLAY HARDWARE SETTINGS (screen type & connections) -------------------
  ...
  #include <Adafruit_SSD1331.h>  // OLED display (96X64)library If you choose this uncomment the define on the next line -OR-
  #define THE1331
  //#include <Adafruit_SSD1351.h>  // OLED display library -OR-
  //#include <Adafruit_ST7735.h> // TFT display library (enable one only)
  #define DISPLAY_DC        8    // Data/command pin for ALL displays
